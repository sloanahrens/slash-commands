...
Examples:
  devbot deploy my-app       # deploy to dev
  devbot deploy my-app prod  # deploy to prod
  devbot deploy my-app --quick  # skip build
  devbot deploy my-app --verify # verify only`,
	Args: cobra.RangeArgs(1, 2),
	Run:  runDeploy,
}
