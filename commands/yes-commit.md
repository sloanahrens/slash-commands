---
description: Commit and push changes for a repository
---

# Commit

Commit and push git changes for a repository. Shows the proposed message, commits, then pushes to origin.
...
After successful commit, push to the remote:
...
**If push fails** (e.g., no upstream, rejected):
- Show the error
...
When committing in a worktree (`.trees/<name>`), the push step handles it automatically.
