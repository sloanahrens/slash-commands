...
# Example: devbot path my-project → /Users/username/code/my-project
```
...
```bash
devbot path my-frontend
# Output: /Users/username/code/my-frontend
```
...
3. Consider `/prime-context <repo>` for previous session context
